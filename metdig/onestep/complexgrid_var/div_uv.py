...
def _by_self(data_source=None, init_time=None, fhour=None, data_name=None, level=500, extent=(50, 150, 0, 65)):
    div = get_model_grid(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name,
                         var_name='div', level=level, extent=extent, x_percent=0, y_percent=0, throwexp=False)
...
def _by_self_3d(data_source=None, init_time=None, fhour=None, data_name=None, levels=500, extent=(50, 150, 0, 65)):
    div = get_model_3D_grid(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name,
                             var_name='div', levels=levels, extent=extent, x_percent=0, y_percent=0, throwexp=False)
...
def _by_uv_3d(data_source=None, init_time=None, fhour=None, data_name=None, levels=500, extent=(50, 150, 0, 65)):
    u = get_model_3D_grid(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name,
                           var_name='u', levels=levels, extent=extent, x_percent=0, y_percent=0, throwexp=False)
    v = get_model_3D_grid(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name,
                           var_name='v', levels=levels, extent=extent, x_percent=0, y_percent=0, throwexp=False)
...
def read_div_uv_3d(data_source=None, init_time=None, fhour=None, data_name=None, levels=500, extent=(50, 150, 0, 65)):

    div, u, v = _by_self_3d(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name, levels=levels, extent=extent)
    if div is not None and u is not None and v is not None:
        return div, u, v

    _log.info('cal div _by_uv_3d')
    div, u, v = _by_uv_3d(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name, levels=levels, extent=extent)
    if div is not None and u is not None and v is not None:
        return div, u, v
