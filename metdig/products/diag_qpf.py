...
def draw_model_cref(cref,map_extent=(60, 145, 15, 55),
    ...
    obj.img['cref'] = cref_contourf(obj.ax, cref,  kwargs=ref_pcolormesh_kwargs)
    obj.save()
    return obj.get_mpl()
...
def draw_hgt_rain(hgt, rain, map_extent=(60, 145, 15, 55),
    ...
    obj.img['rain'] = qpf_pcolormesh(obj.ax, rain, valid_time=valid_time,kwargs=rain_pcolormesh_kwargs)
    obj.save()
    return obj.get_mpl()
...
def draw_mslp_rain_snow(rain, snow, sleet, prmsl, map_extent=(60, 145, 15, 55),
    ...
    obj = horizontal_compose(title=title, description=forcast_info, png_name=png_name, map_extent=map_extent, kwargs=pallete_kwargs)
    obj.img['rain'], obj.img['snow'], obj.img['sleet'] = rain_snow_sleet_pcolormesh(obj.ax, (rain, snow, sleet), valid_time=valid_time)
