...
def _by_self(data_source=None, init_time=None, fhour=None, data_name=None, level=500, extent=(50, 150, 0, 65)):
    wsp = get_model_grid(data_source=data_source, init_time=init_time, fhour=fhour, data_name=data_name, var_name='wsp', level=level, extent=extent, x_percent=0.2, y_percent=0.1, throwexp=False)
