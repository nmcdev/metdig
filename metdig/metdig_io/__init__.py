...
import metdig.metdig_io.cassandra as cassandra_io
import metdig.metdig_io.era5 as era5_io
import metdig.metdig_io.cmadaas as cmadaas_io
import metdig.metdig_io.MDIException as MDIException
...
def get_model_grid(data_source,  throwexp=True, **kwargs):
    ...
    Arguments:
        data_source {[str]} -- [可选择填写如下数据源: cassandra, cimiss, cmadaas, era5)]
